...
class Utilities:
    ...
    def handle_upload(file_types):
        ...
        :param file_types: List of accepted file types, e.g., ["pdf", "txt", "csv", 'xlsx', 'xlsm', 'json']
        """
        ...
        if uploaded_file is not None:
            ...
            def show_excel_file(uploaded_file):
                ...
                shows.columns = shows.columns.astype(str)
                file_container.write(shows)
        ...
        # print(uploaded_file)
        # table = pa.Table.from_pandas(uploaded_file)
        # print(table)
    ...
    @staticmethod
    def setup_gmail_chatbot(model, temperature):
        with st.spinner("Processing..."):
